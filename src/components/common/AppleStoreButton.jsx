...
const AppleStoreButton = ({
  ...
  return (
    <div className="relative w-fit">
      <Link
        href="https://apps.apple.com/us/app/chubbs-army/id6756720892"
        target="_blank"
      >
        <button
          className={`${
          ...
          } cursor-pointer rounded-full px-3 py-3 sm:px-6 sm:py-3  flex items-center gap-2 text-nowrap text-xs sm:text-base`}
        >
